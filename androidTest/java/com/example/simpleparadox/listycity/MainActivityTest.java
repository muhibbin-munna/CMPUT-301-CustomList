...
public class MainActivityTest{
    ...
    public void checkList(){
        ...
        solo.enterText((EditText) solo.getView(R.id.editText_name), "1707081");
        ...
        /* True if there is any text: 1707081 on the screen, wait at least 2 seconds and
        find minimum one match. */
        assertTrue(solo.waitForText("1707081", 1, 2000));

        solo.clickOnButton("ClEAR ALL"); //Select ClEAR ALL
        //True if there is no text: 1707081 on the screen
        assertFalse(solo.searchText("1707081"));
    ...
    public void checkCiyListItem(){
        ...
        solo.waitForText("1707081", 1, 2000);
